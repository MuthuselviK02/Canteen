"""
Temporary fix for analytics dashboard - create a working endpoint
"""
...
@router.get("/api/analytics-dashboard-fix")
async def get_analytics_dashboard_fix(
    db: Session = Depends(get_db),
    current_user: User = Depends(get_current_user)
):
    """Temporary fix for analytics dashboard - bypasses caching issues"""
    try:
        ...
        print(f"Analytics fix: Querying from {utc_start} to {utc_end}")
        ...
        print(f"Error in analytics fix: {e}")
        import traceback
        traceback.print_exc()
        raise Exception(f"Error getting analytics dashboard fix: {str(e)}")
